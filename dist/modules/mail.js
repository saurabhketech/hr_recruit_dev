...
module.exports = {
    sendMail: function sendMail(email, subject, text, from, html, automatic) {
        return new Promise(function (resolve, reject) {
            html += (0, _constant2.default)().add_html_suffix_email_tracking + "&tid=" + _config2.default.TRACKING_ID + "&cid=" + _config2.default.CLIENT_ID + "&t=event&ec=" + subject + "_  " + (0, _moment2.default)().format("YYYY-MM-DD") + "&ea=open&el=" + email + "\"/>";
